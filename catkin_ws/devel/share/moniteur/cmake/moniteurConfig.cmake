...
if(NOT "/home/chloe/.git/Projet_Monitoring/catkin_ws/src/moniteur/include " STREQUAL " ")
  set(moniteur_INCLUDE_DIRS "")
  set(_include_dirs "/home/chloe/.git/Projet_Monitoring/catkin_ws/src/moniteur/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'moniteur' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'chloe <cmaingot@laas.fr>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'moniteur' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chloe/.git/Projet_Monitoring/catkin_ws/src/moniteur/${idir}'.  Ask the maintainer 'chloe <cmaingot@laas.fr>' to fix it.")
    endif()
    _list_append_unique(moniteur_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "moniteur")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/chloe/.git/Projet_Monitoring/catkin_ws/devel/lib;/opt/ros/jade/lib)
