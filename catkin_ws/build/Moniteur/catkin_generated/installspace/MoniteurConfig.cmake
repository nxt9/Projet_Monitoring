...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'Moniteur' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chloe/.git/Projet_Monitoring/catkin_ws/install/${idir}'.  Ask the maintainer 'chloe <chloe@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/chloe/.git/Projet_Monitoring/catkin_ws/install/lib;/home/chloe/.git/Projet_Monitoring/catkin_ws/devel/lib;/opt/ros/jade/lib)
